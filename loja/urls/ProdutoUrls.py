...
from loja.views.ProdutoView import list_produto_view, edit_produto_view, edit_produto_postback, create_produto_view, details_produto_view,delete_produto_view
